...
class TCPMainTest(unittest.TestCase):
    def setUp(self):
        ...
        self.basicArgs = ['-i',"input/dns-hdns-01_2024-01-28_17_54.pcap.gz",'--duration','1','-o',"output/test1k-modified--test_basic.pcap"]
        self.sixSecondsArgs = ['-i',"input/dns-hdns-01_2024-01-28_17_59.pcap.gz",'-z','4','-d','6','-o',"output/test1.pcap"]
        self.one50kArgs = ['-i',"input/dns-hdns-01_2024-01-28_06_34.pcap.gz",'-z',"3",'-o',"output/test2.pcap"]
        self.six50kArgs = ['-i',"input/dns-hdns-01_2024-01-28_06_34.pcap.gz",'-z',"7",'-d',"6",'-o',"output/test3.pcap"]
    def test_basic(self):
    ...
    def test_createPackets(self):
        pkts = m.createPackets("input/test1k-modified--test_basic.pcap","200.7.4.7",20,1.0)
        for (x,y) in pkts:
