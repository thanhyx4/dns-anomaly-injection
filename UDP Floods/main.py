...
def main():
    ...
    parser.add_argument( "-d", "--duration", help = "Duration of the attack ( d: 120s )", type = float, default = 120 )
    parser.add_argument( "-z","--num_zombies", help = "Number of computers in the botnet for the DDoS attack ( d: 5 )", type = int, default = 5 )
    parser.add_argument( "-it", "--initial_time", help = "Seconds of delay to begin the attack ( d: 60 )", type = int, default = 60 )
    ...
    parser.add_argument( "-s","--server_ip", help = "IP address of the target server ( d: 203.119.73.80 )", default = '203.119.73.80' )
